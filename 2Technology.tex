...
For the Database Management System I chose \acrlong{pg}, which is the second most popular choice among database technologies %TODO link to dev survey
...
ASP.NET Core \acrshort{mvc} is a framework optimized for use with ASP.NET Core, that allows to build \acrshort{api}s and web applications using \acrlong{mvc} pattern. % TODO ref https://docs.microsoft.com/en-us/aspnet/core/mvc/overview
